...
public class WarpedFruitProjectile extends ElementalFruitProjectile {
    public WarpedFruitProjectile(EntityType<? extends WarpedFruitProjectile> p_37391_, Level p_37392_) {
        super(p_37391_, p_37392_);
    }

    public WarpedFruitProjectile(Level p_37399_, LivingEntity p_37400_) {
        super(ModEntities.WARPED_FRUIT_PROJECTILE.get(), p_37400_, p_37399_);
    }

    public WarpedFruitProjectile(Level p_37394_, double p_37395_, double p_37396_, double p_37397_) {
        super(ModEntities.WARPED_FRUIT_PROJECTILE.get(), p_37395_, p_37396_, p_37397_, p_37394_);
    }

    protected Item getDefaultItem() {
        return ModItems.WARPED_FRUIT.get();
    }
    ...
    protected void onHit(HitResult hitResult) {
        if (!hit) {
            if (!this.level().isClientSide) {
                ...
                spawnParticlesCircleUpward(hitResult.getLocation(), ModParticles.WARPED_PARTICLE.get(),2.5f);
            }
        }
        hit = true;
