package net.tomsaw31.elementalfruits.networking.packet;
...
public class ItemStackSyncS2CPacket {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            if(Minecraft.getInstance().level.getBlockEntity(pos) instanceof FruitSynthesizerBlockEntity blockEntity) {
